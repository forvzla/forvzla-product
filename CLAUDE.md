...
This repo is the **system of record for product discovery** for ForVzla.
...
- **Features/** — `scope.yaml`, `ARTIFACT-FOR-NNN.md`, optional mockups
...
- Artifact prefix: `ARTIFACT-FOR-NNN` (increment per existing files in `Features/`)
